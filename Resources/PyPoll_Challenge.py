...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        county_vote_percent = (float(county_vote) / float(total_votes) * 100)

         # 6d: Print the county results to the terminal.
        county_results = (
            f'{county_name} had {county_vote_percent:.1f}% of the total vote with {county_vote:,} (votes)\n')
    ...
    largest_county = (
        f'-------------------------\n'
        f'{largest_county_name} was the largest county with {winning_county_voters:,} (votes)\n'
        f'-------------------------\n')
